...
import com.example.shopping.databinding.ActivityShoppingHostBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class ShoppingHostActivity : BaseActivity<ActivityShoppingHostBinding>() {
    ...
    override fun onCreateBinding(inflater: LayoutInflater): ActivityShoppingHostBinding {
        return ActivityShoppingHostBinding.inflate(inflater)
    }
}
